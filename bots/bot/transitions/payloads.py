...
# p = Payloads(shorten=True, show_info=True)
# p.add_words_to_shorten(word=["shop", "courier", "user", "order"])
# p.add_reference(
#     path="type:order/action:order_take",
#     src="first_page",
#     dst="second_page",
# )
# p.add_reference(
#     path="type:item_pick/subtype:shop/action:user_pre/page:/id:",
#     src="first_page",
#     dst="second_page",
# )
# p.add_payload(
#     path="type:item_pick/subtype:courier/action:user_pre/page:/id:",
#     src="first_page",
#     dst="second_page",
# )
# p.add_payload(
#     path="type:item_pick/subtype:courier/action:order_pre/page:/id:",
#     src="source",
#     dst="destination",
# )
# p.add_error_return(error_return="error_return")
# p.compile()
#
#
# async def run(payloads: Payloads):
#     output = await payloads.run(
#         entry_dict={"t": "i", "s": "c", "a": "o_pre", "p": 2, "i": 111}
#     )
